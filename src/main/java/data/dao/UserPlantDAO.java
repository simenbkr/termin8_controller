...
String sql = "UPDATE termin8_django_userownsplant SET plant_id=?, user_id=? WHERE id=?";
    ...
    public void delete(UserPlant userPlant) {
    	String sql = "DELETE FROM termin8_django_userownsplant WHERE id=?";
        try {
            Connection connection = DB.getConnection();
            PreparedStatement st = connection.prepareStatement(sql);
    ...
    public int create(UserPlant userPlant) {
    	String sql = "INSERT INTO termin8_django_userownsplant (plant_id,user_id) VALUES(?,?)";
        int lastId = -1;
        try {
            Connection connection = DB.getConnection();
            PreparedStatement st = connection.prepareStatement(sql);
